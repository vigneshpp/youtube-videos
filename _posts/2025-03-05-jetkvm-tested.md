...
{% include embed/youtube.html id='jaQAfVP0Yq8' %}
📺 [Watch Video](https://www.youtube.com/watch?v=jaQAfVP0Yq8)

## Info

Check out JetKVM: <https://jetkvm.com/>

JetKVM on GitHub: <https://github.com/jetkvm>

Other Products I used (affiliate links below)

- EZCOO Switch (hotkey model): <https://amzn.to/3QKNGU4>
